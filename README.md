...
This is a simple gRPC server that implements Envoy's External Processing (`ext_proc`) API. It acts as an external authorization and inspection filter for Envoy.
